...
One simple test is to feed the model random garbage, repeated twice. Quite amusingly, transformers are able to learn the pattern and predict the second half of the sequence with high accuracy, like in @fig-random-qwen.
...
So what about Mamba? We used [this](https://huggingface.co/state-spaces/mamba-790m) model. And [this](https://github.com/jzhang38/LongMamba) [one](https://huggingface.co/PY007/LongMamba_16384_bs128_step400/tree/main). Here is the result:
...
Ok, what about longer contexts? Mamba should be able to handle really long sequences, right?
